...
WebUI.setText(findTestObject('Page_OrgApp/Object_Invite_Recruiter_popup/Invite_Recruiter_Email_Textbox'), findTestData(
	'InputList').getValue("email",6))

WebUI.click(findTestObject('Page_OrgApp/Object_Invite_Recruiter_popup/Invite_Recruiter_Add_Button'))

WebUI.verifyElementText(findTestObject('Page_OrgApp/Object_Invite_Recruiter_popup/Error_Message_Invalid_Email'),findTestData(
	'InputList').getValue("error message",3))
