...
WebUI.verifyElementPresent(findTestObject('Page_OrgApp/Object_Invite_Recruiter_popup/Invite_Recruiter_Email_TextBox_Text'), 0)

WebUI.verifyElementPresent(findTestObject('Page_OrgApp/Object_Invite_Recruiter_popup/Invite_Recruiter_Add_Button'), 0)

WebUI.verifyElementPresent(findTestObject('Page_OrgApp/Object_Invite_Recruiter_popup/Invite_Recruiter_Email_Address_Header'), 0)

// To check whethet invite button is enable or disable
