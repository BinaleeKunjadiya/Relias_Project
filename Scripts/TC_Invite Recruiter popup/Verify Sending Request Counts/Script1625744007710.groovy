...
WebUI.verifyElementText(findTestObject('Page_OrgApp/Object_Invite_Recruiter_popup/Invite_Recruiter_Sending_Request_0'), 'Sending Requests (0)')
...
WebUI.sendKeys(findTestObject('Page_OrgApp/Object_Invite_Recruiter_popup/Invite_Recruiter_Email_Textbox'), Keys.chord(
		Keys.ENTER))
WebUI.verifyElementText(findTestObject('Page_OrgApp/Object_Invite_Recruiter_popup/Invite_Recruiter_Sending_Request_2'), 'Sending Requests (2)')

WebUI.click(findTestObject('Page_OrgApp/Object_Invite_Recruiter_popup/Invite_Recruiter_Remove_Clickable'))

WebUI.verifyElementText(findTestObject('Page_OrgApp/Object_Invite_Recruiter_popup/Invite_Recruiter_Sending_Request_1'), 'Sending Requests (1)')
